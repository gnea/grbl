...
#define DEFAULT_X_ACCELERATION (10.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
#define DEFAULT_Y_ACCELERATION (10.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
#define DEFAULT_Z_ACCELERATION (10.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
...
// Y and Z don't exist here, not configuring
#define DEFAULT_SPINDLE_RPM_MAX 1000.0 // rpm
#define DEFAULT_SPINDLE_RPM_MIN 0.0    // rpm
#define DEFAULT_STEP_PULSE_MICROSECONDS 10
#define DEFAULT_STEPPING_INVERT_MASK 0
...
#define DEFAULT_INVERT_PROBE_PIN 0        // false
#define DEFAULT_LASER_MODE 0              // false
#define DEFAULT_HOMING_ENABLE 1           // Requires limit switches be installed and looks for one of the limit switches to be activated which triggers "Alarm" mode. In this mode, all machine motion, the spindle
...
#define DEFAULT_X_ACCELERATION (500.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
#define DEFAULT_Y_ACCELERATION (500.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
#define DEFAULT_Z_ACCELERATION (300.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
...
#define DEFAULT_Y_MAX_RATE 1000.0                // mm/min
#define DEFAULT_Z_MAX_RATE 1000.0                // mm/min
#define DEFAULT_X_ACCELERATION (100.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
#define DEFAULT_Y_ACCELERATION (100.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
#define DEFAULT_Z_ACCELERATION (100.0 * 60 * 60) // 500*60*60 mm/min^2 = 500 mm/sec^2
