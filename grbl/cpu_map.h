...
#define COOLANT_MIST_BIT   2 
  ...
  // Define user-control controls (cycle start, reset, feed hold) input pins.
  // NOTE: All CONTROLs pins must be on the same port and not on a port with other input pins (limits).
#define CONTROL_DDR       GPIOB
#define CONTROL_PIN       GPIOB
#define CONTROL_PORT      GPIOB
#define RCC_CONTROL       RCC_APB2Periph_GPIOB
#define GPIO_CONTROLPORT  GPIO_PortSourceGPIOB
...
#define SPINDLE_PWM_RANGE         (SPINDLE_PWM_MAX_VALUE-SPINDLE_PWM_MIN_VALUE)
  ...
  //   7      SPINDLE_ENABLE_BIT                      CONTROL_CYCLE_START_BIT
  //   8      SPINDLE_DIRECTION_BIT                   CONTROL_SAFETY_DOOR_BIT
  //   9      COOLANT_FLOOD_BIT                       COOLANT_MIST_BIT
  //   10     X_LIMIT_BIT
  //   11     Y_LIMIT_BIT
  //   12     Z_LIMIT_BIT
  //   13 14 SWD
