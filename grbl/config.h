...
#define MAX_SPINDLE_SPEED_OVERRIDE        100 // Percent of programmed spindle speed (100-255). Usually 200%.
#define MIN_SPINDLE_SPEED_OVERRIDE         5 // Percent of programmed spindle speed (1-100). Usually 10%.
